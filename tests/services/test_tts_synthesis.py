...
Tests the TTS service integration with factory pattern.
Fish Speech removed in BE-FEAT-2.
"""
...
class TestTTSFactory:
    ...
    def test_fish_local_tts_removed(self):
        """fish_local_tts engine must be removed from factory."""
    ...
    def test_get_irodori_engine(self):
        """Test creating Irodori TTS engine via factory."""
        ...
        assert isinstance(engine, TTSService)
